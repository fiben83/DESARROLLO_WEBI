							...
							<div class="row">
								<div class="col-md-12">
									<div id="center" class="column">
										<div id="content">
											<div id="about">
												<p class="tree"><b>Ingrese los datos del Articulo:</b></p><br/>
												<form method="post" action="/TiendaOnline/go">
													<input name="to" value="admin" type="hidden">
													<input name="action" value="newProduct" type="hidden">
													<p class="line"><span>Codigo de Articulo</span><input name="codigo" value="" type="text"/></p>
													<p class="line"><span>Nombre del Articulo</span><input name="name" value="" type="text"/></p>
													<p class="line"><span>Descripcion</span><input name="descripcion" value="" type="text" maxlength="100"/></p>
													<p class="line"><span>Elija la Imagen</span><input name="imagen" type="file"/></p>
													<p class="line"><span>Precio S/. </span><input name="precio" value="" type="text"/></p>
													<p class="line"><span>Stock Real</span><input name="stockReal" value="" type="text"/></p>
													<p class="line"><span>Stock Total</span><input name="stockTotal" value="" type="text"/></p>
													<p class="line"><span>Estado</span>
													...
													<p class="line"><span>Categoria</span>
														<select id="categoria" name="categoria">
															<option value="" selected="selected">--selecciona--</option>
															<option value="zMujer">Zapatos Mujer</option>
															<option value="zHombre">Zapatos Hombre</option>
													...
													<p class="line"><span>Proveedor</span>
														<select id="proveedor" name="proveedor">
															<option value="" selected="selected">--selecciona--</option>
															<option value="">Prov1</option>
															<option value="">prove2</option>
														</select>
													</p>
