							...
							<div class="row">
								<div class="col-md-12">
									<div id="center" class="column">
										<div id="content">
											<div id="about">
												<p class="tree"><b>OPCIONES DE ADMINISTRACION</b></p>
											</div>
											<p class="line centerred"><%if(info !=null && !info.equals("")) {%><%=info%><%} %></p>
										</div>
										<div id="content">
											<div id="about">
												<p class="tree"><b>Inserte un nuevo articulo<a href="/TiendaOnline/go?to=admin&action=newProduct" class="reg">AQUI</a></b></p>
											</div>
										</div>
										<div id="content">
											<div id="about">
												<p class="tree"><b>Buscar para editar articulo<a href="/TiendaOnline/go?to=search" class="reg">AQUI</a></b></p>
											</div>
										</div>
										<div id="content">
											<div id="about">
												<p class="tree"><b>Opciones de Almacén de Productos <a href="/TiendaOnline/go?to=admin&action=storeProduct" class="reg">AQUI</a></b></p>
											</div>
										</div>
										<div id="content">
											<div id="about">
												<p class="tree"><b>Buscar usuarios<a href="#" class="reg">AQUI</a></b></p>
											</div>
										</div>
										<div id="content">
											<div id="about">
												<p class="tree"><b>Buscar una factura de venta<a href="#" class="reg">AQUI</a></b></p>
											</div>
										</div>
										<div id="content">
											<div id="about">
												<p class="tree"><b>Salir de la cuenta (LOGOUT)<a href="/TiendaOnline/go?to=admin&action=logout" class="reg">AQUI</a></b></p>
											</div>
										</div>
									</div>
								</div>
